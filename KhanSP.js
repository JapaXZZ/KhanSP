...
/* Inject */
if (!/^https?:\/\/([a-z0-9-]+\.)?khanacademy\.org/.test(window.location.href)) { alert("❌ KhanSP Failed to Injected!\n\nVocê precisa executar o KhanSP no site do Khan Academy! (https://pt.khanacademy.org/)"); window.location.href = "https://pt.khanacademy.org/"; }
...
.then(async () => {
    ...
    sendToast("KhanSP injetado com sucesso!");
